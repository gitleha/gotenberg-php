...
it(
    ...
    /**
     * @param float|string|null $paperWidth
     * @param float|string $paperHeight
     * @param float|string|null $marginTop
     * @param float|string $marginBottom
     * @param float|string $marginLeft
     * @param float|string $marginRight
